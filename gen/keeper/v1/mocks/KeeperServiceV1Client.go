...
// KeeperServiceV1Client is an autogenerated mock type for the KeeperServiceV1Client type
type KeeperServiceV1Client struct {
	mock.Mock
}

// CreateItemStreamV1 provides a mock function with given fields: ctx, opts
func (_m *KeeperServiceV1Client) CreateItemStreamV1(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[v1.CreateItemStreamRequestV1, v1.CreateItemResponseV1], error) {
...
func (_m *KeeperServiceV1Client) CreateItemV1(ctx context.Context, in *v1.CreateItemRequestV1, opts ...grpc.CallOption) (*v1.CreateItemResponseV1, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *KeeperServiceV1Client) DeleteItemV1(ctx context.Context, in *v1.DeleteItemRequestV1, opts ...grpc.CallOption) (*v1.DeleteItemResponseV1, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *KeeperServiceV1Client) GetItemStreamV1(ctx context.Context, in *v1.GetItemRequestV1, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.GetItemStreamResponseV1], error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *KeeperServiceV1Client) GetItemV1(ctx context.Context, in *v1.GetItemRequestV1, opts ...grpc.CallOption) (*v1.GetItemResponseV1, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *KeeperServiceV1Client) ListItemsV1(ctx context.Context, in *v1.ListItemsRequestV1, opts ...grpc.CallOption) (*v1.ListItemsResponseV1, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *KeeperServiceV1Client) UpdateItemV1(ctx context.Context, in *v1.UpdateItemRequestV1, opts ...grpc.CallOption) (*v1.UpdateItemResponseV1, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// NewKeeperServiceV1Client creates a new instance of KeeperServiceV1Client. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewKeeperServiceV1Client(t interface {
	mock.TestingT
	Cleanup(func())
}) *KeeperServiceV1Client {
	mock := &KeeperServiceV1Client{}
	mock.Mock.Test(t)
