...
const (
	...
	KeeperServiceV1_GetItemStreamV1_FullMethodName    = "/keeper.v1.KeeperServiceV1/GetItemStreamV1"
...
type KeeperServiceV1Client interface {
	...
	GetItemStreamV1(ctx context.Context, in *GetItemRequestV1, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetItemStreamResponseV1], error)
...
func (c *keeperServiceV1Client) CreateItemStreamV1(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[CreateItemStreamRequestV1, CreateItemResponseV1], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[CreateItemStreamRequestV1, CreateItemResponseV1]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type KeeperServiceV1_CreateItemStreamV1Client = grpc.ClientStreamingClient[CreateItemStreamRequestV1, CreateItemResponseV1]
...
func (c *keeperServiceV1Client) GetItemStreamV1(ctx context.Context, in *GetItemRequestV1, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetItemStreamResponseV1], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &KeeperServiceV1_ServiceDesc.Streams[1], KeeperServiceV1_GetItemStreamV1_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetItemRequestV1, GetItemStreamResponseV1]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type KeeperServiceV1_GetItemStreamV1Client = grpc.ServerStreamingClient[GetItemStreamResponseV1]
...
type KeeperServiceV1Server interface {
	...
	GetItemStreamV1(*GetItemRequestV1, grpc.ServerStreamingServer[GetItemStreamResponseV1]) error
...
func (UnimplementedKeeperServiceV1Server) CreateItemStreamV1(grpc.ClientStreamingServer[CreateItemStreamRequestV1, CreateItemResponseV1]) error {
...
func (UnimplementedKeeperServiceV1Server) GetItemStreamV1(*GetItemRequestV1, grpc.ServerStreamingServer[GetItemStreamResponseV1]) error {
	return status.Errorf(codes.Unimplemented, "method GetItemStreamV1 not implemented")
}
...
func _KeeperServiceV1_CreateItemStreamV1_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(KeeperServiceV1Server).CreateItemStreamV1(&grpc.GenericServerStream[CreateItemStreamRequestV1, CreateItemResponseV1]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type KeeperServiceV1_CreateItemStreamV1Server = grpc.ClientStreamingServer[CreateItemStreamRequestV1, CreateItemResponseV1]
...
func _KeeperServiceV1_GetItemStreamV1_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetItemRequestV1)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(KeeperServiceV1Server).GetItemStreamV1(m, &grpc.GenericServerStream[GetItemRequestV1, GetItemStreamResponseV1]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type KeeperServiceV1_GetItemStreamV1Server = grpc.ServerStreamingServer[GetItemStreamResponseV1]
...
var KeeperServiceV1_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetItemStreamV1",
			Handler:       _KeeperServiceV1_GetItemStreamV1_Handler,
			ServerStreams: true,
		},
	},
