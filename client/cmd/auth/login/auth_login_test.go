...
//	expectedPassword := "testpassword"
//
//	mockClient.On("Login", mock.Anything, mock.Anything, expectedPassword).Return("", errors.New("required flag(s) \"email\" not set"))
//
//	// Act
//	cmd := NewCommand(mockLog, mockClient)
...
//
//	// Set expectations for mock objects
//	mockClient.On("Login", mock.Anything, expectedEmail, expectedPassword).Return("", errors.New("invalid password"))
//
//	// Act
//	cmd := NewCommand(mockLog, mockClient)
//	cmd.SetArgs([]string{"-e", expectedEmail, "-p", expectedPassword})
...
//	func TestNewCommand_InvalidEmailFormat(t *testing.T) {
//		// Arrange
//		mockLog := slog.New(slog.NewJSONHandler(os.Stdout, nil))
//		mockClient := mocks.NewAuthClient(t)
//
